...
class Ruangan{
    ...
    public function getAll(){
        $sql = "SELECT g.nama AS nama_gedung, f.nama AS nama_fasilitas, k.nama AS kategori, r.nama, 
    ...
    public function getRuangan($id){
        $sql = "SELECT g.nama AS nama_gedung, f.nama AS nama_fasilitas, k.nama AS kategori, r.nama, r.lantai, r.status, r.foto, r.id FROM ruangan r
                INNER JOIN gedung g ON g.id = r.gedung_id
                INNER JOIN fasilitas f ON f.id = r.fasilitas_id
